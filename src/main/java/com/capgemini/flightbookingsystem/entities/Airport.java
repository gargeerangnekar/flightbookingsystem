...
public class Airport {
    ...
    public Airport(Integer airportId, String airportName, String city, String contact) {
        super();
    ...
    public String toString() {
        return "Airport [airportId=" + airportId + ", airportName=" + airportName + ", city=" + city + ", contact=" + contact + "]";
    }
}
