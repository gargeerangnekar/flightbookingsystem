...
public class AirlinesAdmins {
    ...
    public AirlinesAdmins() {
        super();
    }

    public AirlinesAdmins(Integer airlineAdminId, String airlineAdminName, String password, String contactNumber, String airlineEmail) {
        super();
